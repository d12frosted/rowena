...
- **Selling.** What is already sitting on a retainer, which is where a good deal of gil
  ...
  recent sales went for, less the margin, once there are enough sales to trust. Recent means
  the last week when a week is enough of them to speak, because a market that moved leaves
  half its history describing a price that no longer exists. The front of
